...
<title>Alugacar | Vistoria de Devolução</title>
					...
					<div
						...
						<nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
							<ol class="breadcrumb breadcrumb-alt">
								...
								<li class="breadcrumb-item" aria-current="page"><a
									class="link-fx"
									href="<c:url value="/locacoes/${ vistoria.locacao.id }"/>">${ vistoria.locacao.id }</a></li>
								<li class="breadcrumb-item" aria-current="page"><a
									class="link-fx" href="">Vistoria de Devolução</a></li>
							</ol>
						</nav>
					</div>
				</div>
			...
			<div class="content">
				...
				<div class="block block-rounded">
					<div class="block-header block-header-default">
						<h3 class="block-title">Dados da vistoria</h3>
					</div>
					<div class="block-content">
						<form
							action="<c:url value="/locacoes/${ vistoria.locacao.id }/vistoria/devolucao"/>"
							method="POST">
							<%@ include file="../form-groups/vistoria.jsp"%>
							<div class="form-group">
								<button type="submit" class="btn btn-alt-success">Enviar</button>
							</div>
						</form>
					</div>
				</div>
