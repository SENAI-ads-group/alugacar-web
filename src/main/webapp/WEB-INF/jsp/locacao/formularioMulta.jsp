				...
				<div class="content content-full">
					<div
						...
						<h1 class="flex-sm-fill h3 my-2">
							Multas em locação <small
								class="d-block d-sm-inline-block mt-2 mt-sm-0 font-size-base font-w400 text-muted">Multas</small>
						</h1>
						<nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
							<ol class="breadcrumb breadcrumb-alt">
								...
								<li class="breadcrumb-item" aria-current="page"><a
									class="link-fx"
									href="<c:url value="/locacoes/${ multa.locacao.id }"/>">${ multa.locacao.id }</a></li>
								<li class="breadcrumb-item" aria-current="page"><a
									class="link-fx" href="">Multa</a></li>
							</ol>
						</nav>
					</div>
				</div>
			...
			<div class="content">
				...
				<div class="block block-rounded">
					<div class="block-header block-header-default">
						<h3 class="block-title">Dados da multa</h3>
					</div>
					<div class="block-content">
						<form
							action="<c:url value="/locacoes/${ multa.locacao.id }/multa"/>"
							method="POST">
							<div class="form-group">
								<label for="multa.descricao">Descrição</label> <input
									type="text" class="form-control" id="multa.descricao"
									name="multa.descricao">
							</div>
							<div class="form-group">
								<label for="multa.dataAutuacao">Data de Autuação</label> <input
									type="date" class="form-control" id="multa.dataAutuacao"
									name="multa.dataAutuacao">
							</div>
							<div class="form-group">
								<label for="multa.valor">Valor</label> <input type="text"
									class="form-control" id="multa.valor" name="multa.valor">
							</div>
							<div class="form-group">
								<label for="multa.gravidade">Gravidade da Multa</label> <select
									class="custom-select" id="multa.gravidade"
									name="multa.gravidade">
									<option value="0">Selecione...</option>
									<c:forEach var="grav" items="${ gravidadeMultaList }">
										<option value="${ grav }">${ grav.nomeFormatado }</option>
									</c:forEach>
								</select>
							</div>
							<div class="form-group">
