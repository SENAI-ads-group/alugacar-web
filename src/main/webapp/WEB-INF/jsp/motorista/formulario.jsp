					...
					<div
						...
						<h1 class="flex-sm-fill h3 my-2">
							Motorista<small
								...
								de cadastro de motorista</small>
						</h1>
						<nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
							<ol class="breadcrumb breadcrumb-alt">
								...
								<li class="breadcrumb-item" aria-current="page"><a
									class="link-fx"
									href="<c:url value="/locacoes/${ motorista.locacao.id }"/>">${ motorista.locacao.id }</a></li>
								<li class="breadcrumb-item" aria-current="page"><a
									class="link-fx"
									href="<c:url value="/motoristas/${ motorista.locacao.id }"/>">${ motorista.nome }</a></li>
							</ol>
						</nav>
					</div>
				</div>
			...
			<div class="content">
				...
				<div class="block block-rounded">
					...
					<div class="block-content">
						...
						<div class="form-group">
							<label for="motorista.cpf">CPF</label> <input type="text"
								class="form-control" id="motorista.cpf" name="motorista.cpf"
								value="${ motorista.cpf }">
						</div>
						<div class="form-group">
							<label for="motorista.registroGeral">Registro Geral</label> <input
								type="text" class="form-control" id="motorista.registroGeral"
								name="motorista.registroGeral"
								value="${ motorista.registroGeral }">
						</div>
						<div class="form-group">
							<label for="motorista.dataNascimento">Data de Nascimento</label>
							<input type="date" class="form-control"
								id="motorista.dataNascimento" name="motorista.dataNascimento"
								value="${ motorista.dataNascimento }">
						</div>
						<div class="form-group">
							<label for="motorista.registroCNH">Registro Geral</label> <input
								type="text" class="form-control" id="motorista.registroCNH"
								name="motorista.registroCNH" value="${ motorista.registroCNH }">
						</div>
						<div class="form-group">
							<label for="motorista.categoriaCNH">Categoria da CNH</label> <select
								class="custom-select" id="motorista.categoriaCNH"
								name="motorista.categoriaCNH" style="width: 100%;">
								<option value="0">Selecione...</option>
								<c:forEach var="cat" items="${ catCNH }">
									<option value="${ cat }"
										${ motorista.categoriaCNH eq cat ? 'selected': '' }>${ cat.nomeFormatado }</option>
								</c:forEach>
							</select>
						</div>
						<div class="form-group">
							<label for="motorista.validadeCNH">Data de Validade da
								CNH</label> <input type="date" class="form-control"
								id="motorista.validadeCNH" name="motorista.validadeCNH"
											...
											<td class="text-center">
												<div class="btn-group">
													<a class="btn btn-sm btn-alt-primary" data-toggle="tooltip"
														title="Editar"
														href="<c:url value="/motoristas/${ motorista.locacao.id }/enderecos/${ end.id }"/>">
														<i class="fa fa-fw fa-pencil-alt"></i>
													</a>
													<form id="form-excluir" method="POST"
														action="<c:url value="/motoristas/${ motorista.locacao.id }/excluir/endereco/${ end.id }"/>">
				...
				<div class="block block-rounded">
					<div class="block-header block-header-default">
						...
						<div class="block-options">
							<a type="button" class="btn-block-option" data-toggle="tooltip"
								title="Novo Telefone"
								href="<c:url value="/motoristas/${ motorista.locacao.id }/adicionar/telefone"/>">
								<i class="fa fa-fw fa-plus"></i>
							</a>
						</div>
					</div>
					<div class="block-content">
						<div class="table-responsive">
							<table class="table table-borderless table-striped table-vcenter">
								...
								<tbody>
									<c:forEach var="tel" items="${ motorista.telefones }">
										<tr>
											<td>${ tel.numero }</td>
											...
											<td class="text-center">
												<div class="btn-group">
													<a class="btn btn-sm btn-alt-primary" data-toggle="tooltip"
														title="Editar"
														href="<c:url value="/motoristas/${ motorista.locacao.id }/telefones/${ tel.numero }"/>">
														<i class="fa fa-fw fa-pencil-alt"></i>
													</a>
													<form id="form-excluir" method="POST"
														action="<c:url value="/motoristas/${ motorista.locacao.id }/excluir/telefone/${ tel.numero }"/>">
														<button type="submit" class="btn btn-sm btn-alt-primary"
															data-toggle="tooltip" title="Excluir">
															<i class="fa fa-fw fa-times"></i>
														</button>
				...
				<div class="block block-rounded">
					<div class="block-header block-header-default">
						...
						<div class="block-options">
							<a type="button" class="btn-block-option" data-toggle="tooltip"
								title="Novo Email"
								href="<c:url value="/motoristas/${ motorista.locacao.id }/adicionar/email"/>">
								<i class="fa fa-fw fa-plus"></i>
							</a>
						</div>
					</div>
										...
										<tr>
											...
											<td class="text-center">
												<div class="btn-group">
													<a class="btn btn-sm btn-alt-primary" data-toggle="tooltip"
														title="Editar"
														href="<c:url value="/motoristas/${ motorista.locacao.id }/emails/${ em.email }"/>">
														<i class="fa fa-fw fa-pencil-alt"></i>
													</a>
													<form id="form-excluir" method="POST"
														action="<c:url value="/motoristas/${ motorista.locacao.id }/excluir/email/${ em.email }"/>">
														<button type="submit" class="btn btn-sm btn-alt-primary"
															data-toggle="tooltip" title="Excluir">
															<i class="fa fa-fw fa-times"></i>
														</button>
